...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '天启', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个不懂编程的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'blog.489822.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '工具, 博客, 教程, 学习笔记', // 网站关键词 英文逗号隔开
